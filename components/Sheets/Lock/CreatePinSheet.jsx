...
const CreatePinSheet = ({ createPinActionSheetRef }) => {
  ...
  const handlePinCodeSubmit = async () => {
    ...
    try {
      ...
      createPinActionSheetRef?.current.hide()
    } catch (error) {
      return error
    }
  }
    ...
    >
      <View className="flex flex-1 ">
        ...
        <View className="flex flex-col items-center justify-center flex-1">
          <Text className="my-5 text-xl text-black">Create a new PIN</Text>
